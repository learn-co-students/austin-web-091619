...
export default class CoffeeForm extends React.Component {
    ...
    // Note: this should be based on an ID not a value in the object. 
    handleDelete = personName => {
        const newPeople = this.state.people.filter( person => person.firstName !== personName)
